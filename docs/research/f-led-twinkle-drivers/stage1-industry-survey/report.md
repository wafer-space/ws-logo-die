...
| T4 — bucket-dump | η ≈ 50 %; 1000× rail-coupling reduction; brown-out smooth | 10 nF MIM (**~5 mm² @ 2 fF/µm²** — corrected 2026-05-04 from "~50k µm²" with 100× cap-arithmetic error; 5 mm² > 2.25 mm² die so bucket cap must shrink to ≤4 nF or move off-die) + 2 switches + non-overlap clk | Less common; well-known to RFID/NFC IC designers | Brown-out-prone harvested rails; pulse LED protection | Steady illumination; when MIM area scarce |
