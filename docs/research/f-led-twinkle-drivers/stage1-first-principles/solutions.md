...
| T4 — bucket-dump | η ≈ 50%; ~1000× rail-coupling reduction; graceful brown-out | 10 nF MIM (~50k µm² @ 2 fF/µm²) + 2 switches | Less common | Brown-out-prone rails; pulse-LED protection | Steady illumination |
